...
public abstract class DinosaurGameGUI extends DinosaurFrame {
	...
	public void setUpKeyLevel1(JPanel keyPanel) {
		...
		exitL.setBounds(6, 175, 34, 31);
		exitL.setIcon(new ImageIcon("l2Grass.PNG"));
		keyPanel.add(exitL);

		JTextArea text = new JTextArea();
		text.setEditable(false);
		text.setFont(new Font("Verdana", Font.PLAIN, 10));
		...
		JLabel dinoBub1 = new JLabel("");
		dinoBub1.setBounds(6, 132, 34, 31);
		dinoBub1.setIcon(new ImageIcon("grassYellow.jpg"));
		keyPanel.add(dinoBub1);
		
		JLabel dinoBubD = new JLabel("- DINOSAUR SEARCH AREA");
		dinoBubD.setFont(new Font("Gurmukhi MT", Font.BOLD, 13));
		dinoBubD.setBounds(52, 132, 179, 31);
		keyPanel.add(dinoBubD);
	}
	...
	public void setUpKeyLevel2(JPanel keyPanel) {
		...
		JLabel exitD = new JLabel("- EXIT");
		exitD.setFont(new Font("Gurmukhi MT", Font.BOLD, 14));
		exitD.setBounds(52, 219, 167, 31);
		keyPanel.add(exitD);

		JLabel eggD = new JLabel("- POINTS");
		eggD.setFont(new Font("Gurmukhi MT", Font.BOLD, 14));
		eggD.setBounds(52, 137, 168, 26);
		keyPanel.add(eggD);
		
		JLabel dinoBub2 = new JLabel();
		dinoBub2.setBounds(6, 176, 34, 31);
		dinoBub2.setIcon(new ImageIcon("grassOrg.jpg"));
		keyPanel.add(dinoBub2);
		
		JLabel dinoBubL = new JLabel("- DINOSAUR SEARCH AREA");
		dinoBubL.setBounds(53, 174, 179, 33);
		keyPanel.add(dinoBubL);
	}
	...
	public void setUpKeyLevel3(JPanel keyPanel) {
		...
		dinoL3.setBounds(52, 171, 179, 33);
		keyPanel.add(dinoL3);
	}
	...
	public JButton addSpeakers() {
		...
		speakerButton.setBounds(1186, 653, 58, 57);
