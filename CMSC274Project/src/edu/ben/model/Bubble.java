 ...
 * bubble is an 2-D char array with the dinosaur in the middle, the bubble is
 * used to see if a human is by a dinosaur
 * 
 * @author abdul
 *
 */
public class Bubble {
	/**
	 * level for the bubble
	 */
	private int level;
	/**
	 * array that stores the bubble array
	 */
	private char[][] bubble;
	/**
	 * size of the bubble
	...
	/**
	 * a list to store the board index on which the bubble is made
	 */
	private ArrayList<int[]> indexList = new ArrayList<int[]>(); // keeps track of the board indexs

	/**
	 * bubble size depends on the level that is passed in
	 * 
	 * @param level
	...
	/**
	 * methods use to display the bubble array
	 * 
	 * @param bubble
	 *            the bubble that is to be displayed
	 */
