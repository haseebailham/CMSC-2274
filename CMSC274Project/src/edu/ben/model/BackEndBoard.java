...
public class BackEndBoard {
	...
	/**
	 * Checks for dino in positions
	 * 
	 * @param dinoPrevPosition
	 *            Dino Previous position
	 * 
	 * @return True if dino was in lava
	 */
	public boolean isDino(int[] dinoPrevPosition) {
		return lm.checkForDino(dinoPrevPosition);
	}
