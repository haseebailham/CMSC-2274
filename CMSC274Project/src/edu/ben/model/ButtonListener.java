...
public class ButtonListener implements ActionListener {
	...
	/**
	 * a boolean used for pterodactyl
	 */
	...
	private class Messages {
		/**
		 * Frame that will be used for messages. Border and background of JOptionPane
		 * will be changed. Pictures may also be added
		 */
		...
		public void herbMessage() {
			...
			/* one of the messages will be randomly picked to display */
			RandomGen r = new RandomGen();
		...
		public void escapeIsland(int points) {
			...
			message.setFont(new Font("Lucida Grande", Font.BOLD, 15));
			message.setForeground(Color.BLUE);
			ImageIcon dinoGif = new ImageIcon("sourceW.gif");
			JOptionPane.showMessageDialog(box, message, "You won!", JOptionPane.INFORMATION_MESSAGE, dinoGif);
		}
	}
