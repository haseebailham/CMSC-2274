...
/**
 * abstract class for dinosaur objects
 * 
 * @author abdul
 *
 */
public abstract class Dino {
	/**
	 * string used for the dinosaur name for to String
	 */
	private String dinoName;
	/**
	 * amount of damage a dinosaur
	 */
	private int dinoDmg;
	/**
	 * amount of moves a dinosaur
	 */
	...
	private int dinoY; // coordinate of dino
	/**
	 * prev location of dinosaur gets set after it moves
	 */
	private int[] prevLocation = new int[2];
	/**
	 * the char that gets placed on board
	 */
	private char charName = 'D'; // dinosaur char name changes per subclass
	/**
	 * boolean to chase human
	 */
	private boolean foundHuman = false;
	/**
	 * boolean if a dino is near human
	 */
	...
	/**
	 * uses the dinosaur bubble to check if a human is in the bubble
	 * 
	 * @return
	 */
